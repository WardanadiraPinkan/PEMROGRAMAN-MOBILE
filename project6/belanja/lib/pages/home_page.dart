...
class HomePage extends StatelessWidget {
  final List<item> items = [
    item(name: 'Sugar', price: 10000, imageUrl: 'assets/sugar.jpeg', stock: 10, rating: 9.5),
    item(name: 'Salt', price: 4000, imageUrl: 'assets/salt.jpeg', stock: 15, rating: 8.0),
  ];
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: const Text('Nama: Wardanadira Pinkan Dwiyuwanda, NIM: 2241760116'),
          ),
        ],
      ),
    );
