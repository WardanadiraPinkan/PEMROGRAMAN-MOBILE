...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container(
      ...
      child: const Text(
        ...
        '\nNIM: 2241760116',
        softWrap: true, // Mengatur agar teks membungkus jika terlalu panjang
      ),
    );

    return MaterialApp(
      title: 'Flutter layout: Wardanadira Pinkan Dwiyuwanda, 2241760116',
      home: Scaffold(
        body: ListView(
          // Hanya gunakan ListView di body
          children: [
            Image.asset(
            ...
            buttonSection, // Menampilkan widget buttonSection
            textSection, // Menampilkan widget textSection
          ],
        ),
      ),
    );
  ...
  // Fungsi untuk membangun button section
